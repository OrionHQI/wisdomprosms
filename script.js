...
if (!country) {
    ...
    if (!service) {
        ...
        try {
            ...
            const response = await fetch(
                `"https://wisdomprosms-backend.onrender.com/dashboard/available-numbers?country=${encodeURIComponent(country)}&service=${encodeURIComponent(service)}`,
                {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`
                            ...
                            async () => {
                                ...
                                try {
                                    ...
                                    const purchaseResponse =
                                        await fetch(
                                            "https://wisdomprosms-backend.onrender.com/dashboard/purchase-number",
                                            {
                                                method: "POST",
...
async function startWalletFunding() {
    ...
    try {
        const response = await fetch("http://wisdomprosms-backend.onrender.com/dashboard/fund-wallet", 
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
